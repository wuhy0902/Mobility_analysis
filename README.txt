...
If you would like to save the figures:
  ...
  (1) Download all folders (even if they are empty) without changing their 
      location. All figures will then be saved automatically into the 
      "sim" and "real_app" folders.

  (2) Alternatively, you can specify a custom save location by passing a 
      "save_path_name" argument to each plotting function.
